export const mockRuns = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        type: "log",
        data: [
          { tool: "LinkedIn", action: "Post scheduled", time: "14:30:06", status: "success" as const },
        ],
      },
      {
        role: "assistant" as const,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        type: "log",
        data: [
          { tool: "Calendar", action: "Event created: 'Sync with Sara'", time: "08:01:02", status: "success" as const },
          { tool: "Slack", action: "DM sent to @sara", time: "08:01:04", status: "success" as const },
        ],
      },
      {
        role: "assistant" as const,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        type: "log",
        data: [
          { tool: "Slack", action: "Fetched 47 messages from #growth", time: "11:15:02", status: "success" as const },
          { tool: "AI", action: "Generated summary (342 words)", time: "11:15:08", status: "success" as const },
          { tool: "Notion", action: "Created page in 'Q4 OKRs'", time: "11:15:11", status: "success" as const },
        ],
      },
      {
        role: "assistant" as const,
...
- @mike: Design onboarding flow v2`,
  ...
  },
  {
    ...
    messages: [
      {
        role: "user" as const,
        content: "Draft a follow-up email for Acme Corp about our pricing discussion, and log it to HubSpot",
      },
      {
        role: "assistant" as const,
        type: "plan",
      ...
      },
      {
        ...
        type: "log",
        data: [
          { tool: "AI", action: "Email draft generated", time: "16:45:03", status: "success" as const },
          { tool: "HubSpot", action: "Activity logged for Acme Corp", time: "16:45:05", status: "success" as const },
        ],
      },
      {
        role: "assistant" as const,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        type: "log",
        data: [
          { tool: "Slack", action: "Fetched 124 messages from 5 channels", time: "17:00:03", status: "success" as const },
          { tool: "Jira", action: "Retrieved 8 tickets with updates", time: "17:00:08", status: "success" as const },
