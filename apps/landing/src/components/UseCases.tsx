    ...
    <section id="use-cases" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground">Preview opens Plan & Diff. Run after connecting apps.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {cases.map((item) => (
            <div key={item.title} className="gradient-card rounded-2xl border border-border p-6 hover:shadow-lg transition-smooth">
        ...
        <div className="text-center mt-8">
          <a href="#templates" className="text-sm underline underline-offset-4">See more routines →</a>
        </div>
      </div>
    </section>
  );
