...
export const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      features: ['1 workspace • Fast Mode + Undo', 'Review when it counts (auto on bulk/risky)'],
      cta: 'Start Starter',
    },
    {
      name: 'Pro',
    ...
    },
    {
      ...
      features: ['Role gates • Audit export • Webhooks', 'Priority support'],
      cta: 'Start Team',
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto mb-6">
          <div className="flex items-center justify-center gap-2 text-sm bg-accent/40 border border-border rounded-xl px-4 py-2">
            ...
            <a href="#pricing-ltd" className="underline underline-offset-4">
              Get Lifetime
            </a>
          </div>
        </div>
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-muted-foreground">Clear per-run pricing. No hidden fees.</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto mb-10">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {plan.messages && <p className="text-muted-foreground mb-6">{plan.messages}</p>}
              ...
              <Button variant={plan.ltd || plan.popular ? 'hero' : 'secondary'} className="w-full">
                {plan.cta}
              </Button>
              {plan.ltd && (
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-center text-xs text-muted-foreground leading-relaxed">
            <strong>Runs</strong> = executions that touch your apps.{' '}
            <strong>Copilot messages</strong> = planning chat & drafts. Per-run overage (if enabled
            outside LTD):
            <strong> €0.02–€0.05 / run</strong>.
            <br />
            Fair-use throttles apply (daily caps, output limits). Planning remains available when
            caps are reached; execution resumes on reset or top-up.
          </p>
        </div>
      </div>
    </section>
