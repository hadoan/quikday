  ...
  const pillars = [
    {
      ...
      icon: (
        <svg width="56" height="56" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Fast">
          <circle cx="30" cy="30" r="28" stroke="currentColor" strokeWidth="2"/>
          <path d="M18 30h24M30 18l12 12-12 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="56" height="56" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Review">
          <rect x="9" y="12" width="42" height="30" rx="4" stroke="currentColor" strokeWidth="2"/>
          <path d="M16 20h20M16 28h28" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    ...
    },
    {
      ...
      icon: (
        <svg width="56" height="56" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Undo">
          <path d="M20 22v-8l-8 8 8 8v-8h10c8 0 14 6 14 14 0 3-1 6-3 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    },
  ];
