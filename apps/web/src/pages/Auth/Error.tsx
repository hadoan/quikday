...
export default function AuthErrorPage() {
  ...
  const errorMessage =
    searchParams.get('message') || 'An unexpected error occurred during authentication';
      ...
      <Card className="w-full max-w-md relative shadow-elegant border-border/50 backdrop-blur-sm bg-card/95">
        <CardHeader className="text-center space-y-6 pb-8">
          ...
          <div className="space-y-2">
            ...
            <CardTitle className="text-2xl sm:text-3xl font-bold">Authentication Failed</CardTitle>
