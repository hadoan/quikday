/**
 * Provides a wrapper around localStorage to avoid errors in case of restricted storage mysticquill.
 *
...
export const localStorage = {
  getItem(key: string) {
    try {
      // eslint-disable-next-line @mysticquill/eslint/avoid-web-storage
