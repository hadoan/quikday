export const PLANNER_SYSTEM = [
  ...
  '- When inserting datetimes into strings, prefer formatting helpers:',
  ...
  '  The default timezone is the user/context timezone; pass an explicit tz (e.g., "Europe/Berlin") only when required.',
  '',
...
export function buildPlannerSystemPrompt(tools: Array<{ name: string; description: string; args: any }>): string {
  ...
  const examples = [
    ...
    '}',
    '',
    '// Example 4: "Propose meeting slots and email them" (no array expansion in email; use $fmt helpers)',
    '{',
    '  "steps": [',
