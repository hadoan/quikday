import { ProviderCapabilities, EmailMessage, SearchQuery, DraftInput, SendOptions, LabelChange } from "./email.types.js";
...
export interface EmailService {
    ...
    sendExistingDraft(draftId: string, opts?: SendOptions): Promise<{ messageId: string; threadId: string }>;

    // ORGANIZE
    changeLabels(target: { threadId?: string; messageId?: string }, delta: LabelChange): Promise<void>;
