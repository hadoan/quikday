...
export const templateData = [
  // Triage & Priorities (1-3)
  {
    ...
    sampleText: 'Give me a {minutes=10}-minute triage of priority emails and create quick-reply drafts (max {max=8}).',
  ...
  },
  {
    ...
    sampleText: 'Run a {minutes=15}-minute inbox sprint: archive newsletters, snooze low-priority items for {snooze=3d}, and surface actionables (max {max=12}).',
  ...
  },
  {
    ...
    sampleText: 'Show top {max=10} time-sensitive threads from the last {days=3} days and draft concise replies.',
  ...
  // Follow-ups & Sweeps (4-6)
  {
    ...
    sampleText: 'Sweep my sent threads with no reply from the last {days=14} days and draft polite nudges (tone {tone=polite|friendly|direct}).',
  ...
  },
  {
    ...
    sampleText: 'Find starred threads older than {days=7} days without response and draft follow-ups (max {max=15}).',
  ...
  // Meeting Prep & Recaps (7-9)
  {
    ...
    sampleText: 'Prepare a one-pager for my {when=date/time or title} meeting with {name/company} using related recent emails; add 3 talking points.',
  ...
  },
  {
    ...
    sampleText: 'Draft a recap for the last meeting with {contact=email} and add a follow-up reminder in {followup=3d} on my calendar.',
  ...
  },
  {
    ...
    sampleText: 'For my next {hours=24} hours of meetings, draft quick "see you soon" emails with agenda bullets to all attendees.',
  ...
  // Scheduling Helpers (10-12)
  {
    ...
    sampleText: 'From my availability over the next {days=7} days, propose {slots=3} 30-min slots and draft a scheduling email to {to=email}.',
  ...
  },
  {
    ...
    sampleText: 'Detect conflicts in the next {days=5} days and draft reschedule emails with {slots=2} alternatives.',
  ...
  },
  {
    ...
    sampleText: 'Create calendar focus blocks tomorrow for top actionable threads (max {max=5}) with {duration=30m} each; link emails in description.',
  ...
  // Digests & Daily Ops (13-15)
  {
    kind: 'daily_digest',
    label: 'Daily Digest',
    sampleText: 'Every weekday at {time=08:45}, send a digest of today\'s meetings, hot emails, and pending follow-ups (max {max=8}).',
  ...
  },
  {
    ...
    sampleText: 'Each {weekday=Mon} at {time=09:00}, summarize key threads from last week, this week\'s meetings, and suggested follow-ups.',
  ...
  },
  {
    ...
    sampleText: 'Extract action items from the last {days=3} days of starred threads and add calendar reminders across {spread=3d}.',
  ...
  // RSVP & Confirmations (16-17)
  {
    kind: 'smart_rsvp',
    label: 'Smart RSVP',
    sampleText: 'For invites in the last {days=7} days, draft RSVP emails based on my calendar availability; accept if free, propose alt slots if busy.',
  ...
  },
  {
    ...
    sampleText: 'Confirm the {title=text} meeting on {date=date} at {time=time} with location {loc=text} and attach a brief agenda.',
  ...
  // Out-of-Office & Boundaries (18-19)
  {
    ...
    sampleText: 'Set an out-of-office from {start=date} to {end=date} with this message: {msg=text}. Draft a heads-up to my top contacts.',
  ...
  },
  {
    ...
    sampleText: 'During {dow=Mon–Fri} {start=13:00}–{end=15:00}, auto-draft "in focus time" replies and suggest booking links from my calendar.',
  ...
  // Cleanup & Hygiene (20-21)
  {
    ...
    sampleText: 'Review next {days=14} days: flag double-bookings, remove declined events, and add buffers of {buffer=10m} around back-to-backs.',
  ...
  },
  {
    ...
    sampleText: 'Collect newsletters from the last {days=7} days into one summary and schedule a single reading block of {duration=20m}.',
  ...
  // Quick Replies & Intros (22-23)
  {
    ...
    sampleText: 'For the top {max=8} threads today, draft short replies ({style=crisp|friendly|formal}) and schedule send for {send_time=17:30}.',
  ...
  },
  {
    ...
    sampleText: 'Draft a double-opt-in intro between {a=email} and {b=email}; schedule a reminder in {remind=5d} to follow up.',
